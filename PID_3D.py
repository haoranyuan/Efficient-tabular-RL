...
def PID_Multi(QUAD_DYNAMICS_UPDATE=0.05,
    ...
    CONTROLLER_PARAMETERS = {'Motor_limits': [5200, 5500],
                             ...
                             'Z_XY_offset': 0,
                             'Linear_PID': {'P': [300, 300, 70000], 'I': [0.04, 0.04, 300], 'D': [450, 450, 70000]},
...
if __name__ == "__main__":
    PID_Multi(QUAD_DYNAMICS_UPDATE=0.2, render=False, reward_flag='default', validation=0, episode=2000)
