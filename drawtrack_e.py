...
'''
reward = np.genfromtxt('reward_AL.csv', delimiter=',')
...
sc = np.genfromtxt('sc_scatter_defaultval0.csv', delimiter=',')[:, 0]
success_scatter1  = moving_average(np.genfromtxt('sc_scatter_defaultval0.csv', delimiter=',')[:, 0], 300)
